...
$(function () {
    ...
    (function (app) {
        ...
        */
        ...
        var root = 'https://localhost/probe/'; //GetRootUrl();  //root directory of the web site serving mobile app (i.e. in-common-app.com)
            ...
            */
            ...
            $('#startGamePlay').click(function (event) {
                ...
                //This is a hack for IPAD to ensure that the fixed nav bar is positioned corrected
                    //$('header, footer').css('position', 'absolute'); MNS ADDED
        ...
        */
        app.StartGame = function (questionNbr) {
            ...
            */
            ...
            app.SetQuestionPage(currentQuestionNbr, 'none')
            //$(":mobile-pagecontainer").pagecontainer('change', '#question', { transition: 'none' }); //MNS ADDED
