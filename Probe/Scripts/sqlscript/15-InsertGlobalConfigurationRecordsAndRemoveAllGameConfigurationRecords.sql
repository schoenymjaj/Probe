...
INSERT INTO ConfigurationG (Name, Description, DataTypeG, ConfigurationType, Value)
VALUES ('QuestionTimeWarningInSecs','Number of seconds before the question deadline that a player receives a warning notification if they haven''t answered/submitted a question. You can disable warning messages to the player by setting this property to zero',1,1,'60')
