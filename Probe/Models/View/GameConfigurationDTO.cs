...
namespace Probe.Models.View
{
    public class GameConfigurationDTO
    {
        ...
        [Required]
        public ProbeDAL.Models.ConfigurationG.ProbeDataType DataTypeG { get; set; }

        [Required]
        public ProbeDAL.Models.ConfigurationG.ProbeConfigurationType ConfigurationType { get; set; }
